...
async function loadFacts() {
  const res = await fetch(
    "https://zswhkcmkkfdzxsgecmkx.supabase.co/rest/v1/facts",
    {
      headers: {
        apikey:
        ...
        authorization:
          "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Inpzd2hrY21ra2ZkenhzZ2VjbWt4Iiwicm9sZSI6ImFub24iLCJpYXQiOjE2ODI5NDcyODMsImV4cCI6MTk5ODUyMzI4M30.39opXWD6cEAwGTPMNDTMq-5A3ZjQAfmgCTs_DUNpEzU",
      },
    }
  );
